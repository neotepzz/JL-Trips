...
$query2 = mysql_query("SELECT * FROM `trips` WHERE `createdby`='$username' AND `tripfinalised`='1'");  //query the entire trips table for all data from all rows + columns NEEDS CHANGING TO SPECIFIC
