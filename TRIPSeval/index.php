...
<body>
	<div id="page-container">
		...
		<div id="sidebar-a">
			<div class="padding">
			<h2>Help</h2>
			<p>Please proceed to either Pre-Trips or Trips by selecting the appropriate link. </p>
			</div>
		</div>
		<div id="content">
			<div class="padding">
			<h2>Pre Trips</h2>
			<p><a href="pretrip_menu.php">View Pre Trips & Options</a></p>
			<h2>Trips</h2>
			<p><a href="trip_menu.php">View Trips & Options</a></p>		
<?php
include ("common.php");
global $adminquery2;
if ($adminquery2 > 0) {
