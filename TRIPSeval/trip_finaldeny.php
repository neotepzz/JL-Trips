...
mysql_query("UPDATE `trips` SET `tripaccepted`='0', `tripfinalised`='1', `tripdenied`='1', `tripsubmitted`='0' WHERE `tripid`='$tripid'"); //updates database to show that the trip is denied.
$acceptmessage ='<h2>Denying this Trip... </h2>';
$username = $_SESSION['username'];
mysql_query("INSERT INTO log (user, logtime, logdesc, logtripid) VALUES ('$username', NOW(), 'Denied Trip', $tripid)");
...
//email setup syntax is mail(to,subject,message,headers,parameters)
		...
		$body = "This Trip - $tripid has been DENIED by $username.  For the following reason: $drr.";
		$subject = "This Trip - $tripid has been DENIED by $username.";
		$to = $email;
		mail($to, $subject, $body, $headers);
}
else
{
$acceptmessage ='<h2>Could not deny this Trip, please contact NSC...</h2>';
};
?>
...
<body>
	<div id="page-container">
		...
		<div id="header"><h1>Trip Denied</h1></div>
		<div id="sidebar-a">
			<div class="padding">
			<h2>Help</h2>
