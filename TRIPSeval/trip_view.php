...
<?php include("trip_view_user_table.php"); ?>
<?php 
require("connect_mysql_database.php");
$username = $_SESSION['username'];
//this if & while statement below allows the program to extract data about the trip
$query2 = mysql_query("SELECT * FROM `trips` WHERE `trip`='1' AND `delete`='0' AND `tripdenied`='1' AND `createdby`='$username'");  //query the entire trips table for all data from all rows + columns
...
<body>
	<div id="page-container">
		...
		<div id="header"><h1><?php echo $username?>'s Trips</h1></div>
		<div id="sidebar-a">
			<div class="padding">
			<h2>Help</h2>
			<p>Here you can Edit, Delete or Submit your Trip.</p>
			<p>If you've already submitted your Trip you will be unable to Edit, Delete or Submit the Trip.
			</div>
		</div>
		<div id="content">
			<div class="padding">
			<h2>Trips</h2>
			<table><tr class="trborder"><th>Trip Description</th><th>School Status</th><th>Trip Status</th><th>Created Date</th><th>Edit Trip</th><th>Delete Trip<th>Submit Trip</th></tr>
			<?php echo $trip_list; ?>
			</table>	
			</div>
		</div>
