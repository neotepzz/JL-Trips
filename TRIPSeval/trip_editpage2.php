...
<tr>
<td>
<form action="trip_update.php?edittripidpage2=<?php echo $gettripid; ?>" method="post">
<table>
	<tr>
		<th><label for="RiskExample1">Risk Example 1<label></th><td><input type="number" required name="RiskExample1" id="RiskExample1" min="1" max="5"> </td>
	</tr>
	<tr>
		<th><label for="RiskExample2">Risk Example 2<label></th><td><input type="number" name="RiskExample2" id="RiskExample2" min="1" max="5"></td>
	</tr>
	<tr>
		<th><label for="RiskExample3">Risk Example 3<label></th><td><input type="number" name="RiskExample3" id="RiskExample2" min="1" max="5"></td>
	</tr>
	<tr>
		<th><label for="RiskExample4">Risk Example 4<label></th><td><input type="number" name="RiskExample4" id="RiskExample2" min="1" max="5"></td>
	</tr>
<tr>
<td colspan="2">
