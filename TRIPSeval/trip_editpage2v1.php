...
<html>
<head>
<script type="text/javascript" src="javascript/showFirstChoice.js"></script>
...
//request an array of results from the activity type menu.
$sql1 = mysql_query("SELECT * FROM `activity`");

?>
<body>
<form action="">

<select name="" onchange="showFirstChoice(this.value, <?php echo $gettripid; ?>)">
<option value="">Select an Activity:</option>
<?php 
//use a while statement to populate the list of dropdown options for someone to select.
while ($row1 = mysql_fetch_array($sql1))
{
//request an array of results from the activity type menu.
$sql2 = mysql_query("SELECT * FROM `trip_activity_risk` WHERE `tripid`='$gettripid'");
?>
//<option value="<?php echo $row1['activityid']; ?>" <?php if () {echo 'selected="selected"';}?>><?php echo $row1['activitytype']; ?></option> 
<?php } ?>
</select>
</form>
				<div id ="first-choice">
					<p>First choice info will be listed here...</p>
				</div>
				<div id="second-choice">
					<p>Second choice info will be listed here...</p>
				</div>
				<div id="third-choice">
					<p>Third choice info will be listed here...</p>
				</div>
				<div id="fourth-choice">
					<p>Fourth choice info will be listed here...</p>
				</div>
				<div id="fifth-choice">
					<p>Fifth choice info will be listed here...</p>
				</div>
			</div>
		</div>
		<div id="footer">
