...
<body>
	<div id="page-container">
		...
		<div id="header"><h1>Edit Pre-Trip</h1></div>
		<div id="sidebar-a">
			<div class="padding">
			<h2>Help</h2>
...
<td>
<input type='checkbox' name='chkLGS' value='1' <?php echo $lgs1; ?>>
</td>
</tr>
<tr>
<th>
...
<td>
<input type='checkbox' name='chkLHS' value='1' <?php echo $lhs1; ?>>
</td>
</tr>
<tr>
<th>
...
<td>
<input type='checkbox' name='chkFFD' value='1' <?php echo $ffd1; ?>>
</td>
</tr>
<tr>
<th>
...
<option value ="PE" <?php echo $s18; ?>>PE</option>
<option value ="Sports" <?php echo $s19; ?>>Sports</option>
<option value ="Pastoral" <?php echo $s20; ?>>Pastoral</option>
</select>
</td>
</tr>
<tr>
